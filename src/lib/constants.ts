 ...
 */
export const APP_NAME: string = 'DropCast';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Make airdrops for users who engage with your Farcaster post.';
 ...
 */
export const APP_TAGS: string[] = ['airdrop', 'tokens', 'farcaster', 'rewards', 'engagement', 'community', 'crypto', 'miniapp', 'onchain', 'distribution', 'cast', 'neynar', 'mintclub', 'base'];
 ...
 */
export const APP_SPLASH_BACKGROUND_COLOR: string = '#FFE4E1';
 ...
 */
export const APP_BUTTON_TEXT: string = 'Create Airdrop';
...
/**
 * Empty merkle root for public airdrops
 */
